...
const ProductCard = ({ product }: ProductCardProps) => {
  return (
    <div className="product-card group relative flex flex-col items-start justify-center p-4 w-[260px] shrink-0">
      <div className="relative">
        ...
        <div className="pointer-events-none group-hover:pointer-events-auto absolute inset-x-0 bottom-3 flex justify-center opacity-0 transition-all duration-300 ease-out translate-y-2 group-hover:translate-y-0 group-hover:opacity-100">
